  ...
  const allBars = array.map((value, index) => {
    ...
    <div className="app  ">
     <div className="flex flex-row justify-center md:pt-8 pt-4">
      ...
      <div className="flex flex-row justify-center md:pt-8 pt-4">
      <button onClick={handleStart} className="rounded-full hover:bg-gray-900 py-2 px-3 font-lg bg-sky-900 text-gray-100 " >Start the sort</button>
      </div>
      <div className="flex flex-row justify-center md:pt-8 pt-4">
